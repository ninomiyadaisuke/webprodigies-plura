        ...
        <TableBody className="truncate font-medium">
          {allCharges.map((charge) => (
            <TableRow key={charge.id}>
              <TableCell className="w-[200px]">{charge.description}</TableCell>
              <TableCell className="w-[200px]">{charge.id}</TableCell>
              <TableCell className="w-[300px]">{charge.date}</TableCell>
