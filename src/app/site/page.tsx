...
export default function Home() {
  return (
    <>
      <section className="relative mt-[-70px] flex size-full flex-col items-center justify-center md:pt-44 ">
        {/* grid */}
        ...
        <div className="relative flex items-center justify-center md:mt-[-70px]">
          <Image
            ...
            width={1200}
          />
          <div className="absolute inset-x-0 bottom-0 top-[50%] z-10 bg-gradient-to-t dark:from-background"></div>
        </div>
      </section>
