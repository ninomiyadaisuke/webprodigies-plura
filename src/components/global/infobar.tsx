          ...
          <Sheet>
            ...
            <SheetContent className="mr-4 mt-4 overflow-scroll pr-4">
              ...
              {allNotifications?.map((notification) => (
                <div className="mb-2 flex flex-col gap-y-2 overflow-x-scroll text-ellipsis" key={notification.id}>
                  <div className="flex gap-2">
                    <Avatar>
                      <AvatarImage alt="Profile Picture" src={notification.User.avatarUrl} />
