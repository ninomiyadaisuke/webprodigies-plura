  ...
  switch (action.type) {
    ...
    case 'REDO': {
      if (state.history.currentIndex < state.history.history.length - 1) {
        ...
        const nextEditorState = { ...state.history.history[nextIndex] } as Editor;
        const redoState = {
          ...state,
    ...
    case 'UNDO': {
      if (state.history.currentIndex > 0) {
        ...
        const prevEditorState = { ...state.history.history[prevIndex] } as Editor;
        const undoState = {
          ...state,
...
const EditorProvider = ({ children, subaccountId, funnelId, pageDetails }: EditorProps) => {
